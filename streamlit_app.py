...
st.markdown(f"""
    ...
    /* CARD INTERNE */
    .ios-card {{ background: rgba(28,28,30,0.9); border-radius: 30px; padding: 25px; color: white; margin: 10px; border: 1px solid #2c2c2e; }}
    ...
    .val-neon {{ font-size: 24px; font-weight: 700; color: #0a84ff; }}
    </style>
...
if not st.session_state.user:
    st.markdown(f'<div class="ios-pill-container"><h1 class="main-title">GOPRESSA</h1><p class="status-text">Identification Required</p></div>', unsafe_allow_html=True)
