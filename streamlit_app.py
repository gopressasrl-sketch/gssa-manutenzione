...
# --- 2. SUPER CSS: IPHONE 17 PRO MAX HORIZONTAL (PULIZIA TOTALE) ---
st.markdown(f"""
    <style>
    ...
    /* DYNAMIC ISLAND (PILLOLA IN ALTO) */
    .dynamic-island {{
